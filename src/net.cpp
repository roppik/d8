...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "D8coin " + FormatFullVersion();
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. D8coin is probably already running."), addrBind.ToString().c_str());
        else
